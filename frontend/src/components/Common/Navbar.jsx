...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="container mx-auto flex items-center justify-between py-4 px-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button onClick={toggleCartDrawer} className="relative hover:text-black">
                        ...
                        {cartItemCount>0 && (<span className="absolute -top-1 right-0 bg-glam-pink text-white text-xs rounded-full px-2 py-0.5">
                            {cartItemCount}
                        </span>)}
                    </button>

                    {/* Search icon or menu (mobile) */}
            ...
            {/* mobile navigation */}
            <div className={`fixed top-0 left-0 w-3/4 sm:ww-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${
